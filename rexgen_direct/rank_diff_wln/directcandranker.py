...
if __name__ == '__main__':
    ...
    react = '[C:21]([CH3:22])([CH3:23])([CH3:24])[N:25]=[C:26]=[O:27].[H-:19].[Na+:20].[O:28]1[CH2:29][CH2:30][CH2:31][CH2:32]1.[OH:1][c:2]1[cH:3][cH:4][c:5]([CH2:8][CH2:9][O:10][c:11]2[cH:12][cH:13][c:14]([CH:15]=[O:16])[cH:17][cH:18]2)[cH:6][cH:7]1'
